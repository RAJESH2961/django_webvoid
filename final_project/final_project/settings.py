...
SECRET_KEY = 'django-insecure-!fp6*%cwy^c(44fp*!3uzcxb)q5jcdl26cly_=lba9i!j&j%il'
...
TEMPLATES = [
    {
        ...
        'DIRS':[r'C:\Users\Lenovo\Desktop\final_project\final_project\templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# EMAIL_HOST_PASSWORD='ofxkxuilhltozkxn'
# settings.py
